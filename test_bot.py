...
class TestDatabaseFunctions(unittest.TestCase):
    ...
    def test_unique_driver_constraint(self):
        ...
        self.assertFalse(result2, "Second user should NOT be able to select Max Verstappen")
    ...
    def test_user_can_change_pick(self):
        ...
        self.assertEqual(pick['driver'], 'George Russell', "Driver should be updated to George Russell")
...
class TestBotFunctionality(unittest.TestCase):
    ...
    def test_team_filtering_logic(self):
        ...
        self.assertEqual(len(available_teams), 3, "All teams should have some available drivers")
    ...
    def test_all_drivers_taken_scenario(self):
        ...
        self.assertEqual(len(available_teams), 0, "No teams should have available drivers")
